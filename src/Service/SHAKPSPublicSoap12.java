...
public class SHAKPSPublicSoap12
{
    interface SHAIWcfMethod
    {
        SHAExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(SHAExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public SHAKPSPublicSoap12(){}

    public SHAKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public SHAKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        SHAExtendedSoapSerializationEnvelope envelope= new SHAExtendedSoapSerializationEnvelope(SHAExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,SHAExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,SHAExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new SHAIWcfMethod()
        {
            ...
            @Override
            public java.lang.Object ProcessResult(SHAExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(SHAIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,SHAExtendedSoapSerializationEnvelope envelope)
    {
